      ...
      <form class="space-y-4" @submit.prevent="$router.push({ name: 'jobs' })">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            />
            <label for="remember-me" class="ml-2 block text-sm text-gray-900 cursor-pointer"> Resume Validation </label>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                class="h-4 w-4 text-indigo-600 focus:ring-0 border-gray-300 rounded cursor-pointer"
              />
              <label for="remember-me" class="ml-2 block text-sm text-gray-900 cursor-pointer"> Test Gorilla </label>
            </div>
          </div>
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                class="h-4 w-4 text-indigo-600 focus:ring-0 border-gray-300 rounded cursor-pointer"
              />
              <label for="remember-me" class="ml-2 block text-sm text-gray-900 cursor-pointer"> HR Interview </label>
            </div>
          </div>
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                class="h-4 w-4 text-indigo-600 focus:ring-0 border-gray-300 rounded cursor-pointer"
              />
              <label for="remember-me" class="ml-2 block text-sm text-gray-900 cursor-pointer"> Financial Interview </label>
            </div>
          </div>
        </div>
